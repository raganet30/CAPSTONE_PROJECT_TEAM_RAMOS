         ...
         <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Weekly Consultation Report</h4>
                    </div>
...
INNER JOIN healthworker ON consultation.hw_id = healthworker.hw_id where YEARWEEK(consultation_date) = YEARWEEK(NOW()) order by consultation_id asc " ;
                            ...
                            if($cnt>0)
                            {
                                ...
                                <a href="print-cons-weekly-report.php"  target="_blank" class="btn btn-secondary btn-block"  ><i class="fas fa-print"></i> PRINT REPORT</a> 
                                <?php
                                }
                            ?>
                            </div>
